  ...
  ar: {
    translation: {
      ...
      login: {
        ...
        toSignup: "أول مرة؟ أنشئ حسابك بالرمز السري",
      },
      signup: {
        title: "إنشاء حساب الدخول",
        intro: "أدخل رمزك السري المعتاد مع بريدك الإلكتروني وكلمة مرور جديدة — يُستخدم الرمز مرة واحدة لربط حسابك ثم تدخل بالبريد دائماً.",
        pin: "الرمز السري", confirm: "تأكيد كلمة المرور",
        create: "إنشاء الحساب", link: "ربط الحساب",
        toLink: "لديك حساب بالفعل أو أكدت بريدك؟ اربطه بالرمز",
        toNew: "ليس لديك حساب؟ أنشئ واحداً",
        toLogin: "العودة لتسجيل الدخول",
        confirmSent: "أرسلنا رسالة تأكيد لبريدك — أكد بريدك ثم اربط الحساب هنا بنفس البيانات.",
        mismatch: "كلمتا المرور غير متطابقتين", short: "كلمة المرور 8 أحرف على الأقل",
        badPin: "رمز سري خاطئ", pinUsed: "هذا الرمز مربوط بحساب بالفعل — راجع المسؤول",
        emailTaken: "هذا البريد مسجّل بالفعل — جرّب ربط الحساب",
        badCreds: "بريد أو كلمة مرور غير صحيحة",
        notEnabled: "الحساب غير مفعّل في البوابة — راجع المسؤول",
        signupFailed: "تعذّر إنشاء الحساب — حاول مجدداً",
        network: "تعذّر الاتصال — حاول مجدداً",
      },
      status: {
      ...
      req: {
        ...
        reqLinesTitle: "بنود الطلب — لكل بند مادة وكمية وسعر وحدة، والقيمة تُشتق",
        itemPick: "اختر المادة من القائمة الموحدة", freeText: "— نص حر —",
        freeItemPh: "اسم المادة / الخدمة (نص حر)",
  ...
  en: {
    translation: {
      ...
      login: {
        ...
        toSignup: "First time? Create your login with your PIN",
      },
      signup: {
        title: "Create your login",
        intro: "Enter your usual PIN plus your email and a new password — the PIN is used once to link your account, then you always sign in with email.",
        pin: "PIN", confirm: "Confirm password",
        create: "Create account", link: "Link account",
        toLink: "Already have an account or confirmed your email? Link it with your PIN",
        toNew: "No account yet? Create one",
        toLogin: "Back to sign in",
        confirmSent: "Confirmation email sent — confirm your email, then link the account here with the same details.",
        mismatch: "Passwords don't match", short: "Password must be at least 8 characters",
        badPin: "Wrong PIN", pinUsed: "This PIN is already linked to an account — contact the admin",
        emailTaken: "This email is already registered — try linking the account",
      ...
      req: {
        ...
        reqLinesTitle: "Request lines — item, quantity and unit rate per line; the value is derived",
        itemPick: "Pick from the canonical items", freeText: "— free text —",
        freeItemPh: "Item / service name (free text)",
